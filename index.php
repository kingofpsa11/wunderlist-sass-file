        ...
        <div id="tasks">
            ...
            <div class="task-scroll">
                ...
                <div class="task-list inbox">
                    ...
                    <ol class="tasks">
                        <?php
                        if (isset($_SESSION['database']['doing'])) {
                            foreach ($_SESSION['database']['doing'] as $value) {
                        ?>
                        <li class="taskItem <?php echo $_SESSION['click']['id'] == $value['id'] ? 'selected' : '' ; ?>" rel="php">
                            <div class="taskItem-body">
                                ...
                                <form action="tasks.php" method="get" name="<?php echo "frm" . $value['id'] ?>">
                    ...
                    <ol class="tasks">
                        <?php
                            if (isset($_SESSION['database']['done'])) {
                                foreach ($_SESSION['database']["done"] as $value) {
                        ?>
                        <li class="taskItem done" draggable="true" rel="' . $obj->id . '">
                            <div class="taskItem-body">
                                <a class="taskItem-checkboxWrapper">
                                    <span>
